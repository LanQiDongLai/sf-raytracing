...
int main() {
  ...
  auto ground_material1 = std::make_shared<sf::Lambertian>(sf::Color(1., 1., 1.));
  auto ground_material2 = std::make_shared<sf::Lambertian>(sf::Color(0.3, 0.3, 0.3));
  world.add(std::make_shared<sf::InfiniteChess>(0, 1,
                                         ground_material1, ground_material2));
